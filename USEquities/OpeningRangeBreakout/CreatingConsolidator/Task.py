'''
Task Objectives
Create a 30 minute consolidator, which calls an event handler self.OnDataConsolidated.
Create a function OnDataConsolidated() and save the bar to self.currentBar.
'''
