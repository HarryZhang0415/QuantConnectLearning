'''
Task Objectives
In our OnSecuritiesChanged() method:

Call for 500-bars of history data for each symbol in the pair and save to the variable history.
Use unstack to save the close prices to the variable history.
Iterate through the history tuple and update the spreadMean and spreadStd with historical data.
'''
