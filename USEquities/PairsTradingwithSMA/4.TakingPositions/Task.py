'''
Task Objectives
In the constructor, set self.period to timedelta(hours=2).
Write an if statement where one Insight.Group is emitted when the spread is greater than the upperthreshold and another Insight.Group is emitted when the spread is less than the lowerthreshold.
In our SMAPairsTrading class, use the OnEndOfDay() method to Log your positions at the close of each trading day.
'''
