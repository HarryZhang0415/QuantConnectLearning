'''
Task Objectives
In the constructor, create a 500-period Simple Moving Average to self.spreadMean
In the constructor, create a 500-period Standard Deviation indicator to self.spreadStd
In the Update() method, update the self.spreadMean indicator with the spread.
In the Update() method, update the self.spreadStd indicator with the spread.
In the Update() method, calculate our upper and lower threshold using the current value of self.spreadMean and self.spreadStd.
'''
