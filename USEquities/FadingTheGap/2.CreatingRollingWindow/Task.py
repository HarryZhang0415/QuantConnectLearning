...
In Initialize(), create a RollingWindow with type TradeBar and length of 2 as self.window
In the self.ClosingBar method, add the current TradeBar of TSLA to our rolling window.
In the self.OpeningBar method, add the current TradeBar of TSLA to our rolling window.
'''
